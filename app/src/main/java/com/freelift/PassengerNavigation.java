...
import com.freelift.passenger.navigation.Home;
import com.freelift.passenger.navigation.MyRides;
import com.freelift.passenger.navigation.PrivacyPolicy;
import com.freelift.passenger.navigation.UpdateProfile;
...
public class PassengerNavigation extends AppCompatActivity implements Constants {
...
// Generate title
        pDialog = new ProgressDialog(PassengerNavigation.this);
        pDialog.setMessage("Please wait...");
        pDialog.setCancelable(false);
        title = new String[]{"Home", "My Rides", "Privacy Policy", "Update Profile", "Logout"};
        // Generate icon
        ...
        mMenuAdapter = new MenuListAdapter(PassengerNavigation.this, title, icon);
                ...
                switch (position) {
                    case 0:
                        if (!ConnectionDetector.getInstance().isConnectingToInternet()) {
                            ...
                            Toast.makeText(PassengerNavigation.this, "Please check your Internet connection", Toast.LENGTH_SHORT).show();
                    ...
                    case 4:
                        if (!ConnectionDetector.getInstance().isConnectingToInternet()) {
                            ...
                            AlertDialog.Builder alertDialog = new AlertDialog.Builder(PassengerNavigation.this);
                            LayoutInflater inflater = PassengerNavigation.this.getLayoutInflater();
...
//        SplashPage.customer_driver_login_id = Long.parseLong("0");
        stopService();
        Intent in = new Intent(PassengerNavigation.this, LoginActivity.class);
        startActivity(in);
        PassengerNavigation.this.finish();
    }
